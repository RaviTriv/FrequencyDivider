...
nextpnr-ice40 --force --json $PROJECTNAME.json --pcf icebreaker.pcf --asc $PROJECTNAME.asc --freq $BOARD_FREQ --$FPGA_VARIANT --package $FPGA_PACKAGE --pcf-allow-unconstrained || exit
